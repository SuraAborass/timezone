        ...
        children:  [
              ...
              child: Hero(tag: "product",
                child: Container(
                  decoration: BoxDecoration(
                      image: DecorationImage(image: NetworkImage(featuredProduct.images[0]),
                          fit: BoxFit.cover),
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ListTile(
                    title:  Text(featuredProduct.brand,style: title5,textAlign: TextAlign.start),
                    subtitle: Text(featuredProduct.name,style: title5.copyWith(fontSize: 10),)
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    const SizedBox(width: 20,height: 1,),
                    Text(featuredProduct.price,style:num.parse(featuredProduct.offer)>0 ? title7.apply(decoration: TextDecoration.lineThrough):titleCopy7),
                    const SizedBox(width: 30,height: 1,),
                    if(num.parse(featuredProduct.offer)>0) Text(featuredProduct.offer,style: title8),
                  ],
                ),
              ],
            ),
