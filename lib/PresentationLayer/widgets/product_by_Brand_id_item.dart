...
class ProductByBrandIdItem extends StatelessWidget {
   ProductByBrandIdItem({Key? key,required this.product}) : super(key: key);
  final Product product;
  final ProductsByBrandIdController productController = Get.find();
